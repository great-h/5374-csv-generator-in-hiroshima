...
describe Parser do
  describe '#areas' do
    ...
    it 'big' do
      big = subject.first[8]
      expect(big).to eq('20130412 20130426 20130510 20130524 20130614 20130628 20130712 20130726 20130809 20130823 20130913 20130927 20131011 20131025 20131108 20131122 20131213 20131227 20140110 20140124 20140214 20140228 20140314 20140328')
    end
  end
end
